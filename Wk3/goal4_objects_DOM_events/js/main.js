...
// this is integrating multiple data types - object with an array of objects
    ...
    var university1 = {
        ...
        students:[
            ...
            {name:'John Smith', GPA:4.2, classes:['MMD1', 'MMD2']},
            {name:'William Everett', GPA:3.7, classes:['SDI', 'DWS']}
        ]
    };

    console.log(university1.schoolName);
    console.log(university1['schoolName']);

    var newCnt = 'studentCount';

    console.log(university1[newCnt]);

    console.log(university1['address']);

    console.log(university1.students[0].GPA);
    console.log(university1['students'][2]['GPA']);
...
----------------------------------------------------------------------------- */
    ...
    var gradeAvg = function(obj){
        ...
        for( i = 0, j = obj.students.length; i < j; i++){
            gpaSum += obj.students[i].GPA;
        }
        gpaAvg = gpaSum / obj.students.length;
        return gpaAvg;
    };

    console.log(gradeAvg(university1));
...
*/
    ...
    var student = {name:'JamesBond', gender:'male', job:'student'};

...
fightBtn.addEventListener('click', function(){
    console.log(players[0].name + ' : ' + players[0].health + ' *START* ' + players[1].name + ' : ' + players[1].health);   //Starting Alert
    ...
    for (var i = 0; i < 10; i++) {   //Set counter to count to 10
        ...
        if (!gameOver) {      //If game over is false execute.
            console.log(players[0].name + ' : ' + players[0].health + ' *ROUND ' + round + ' IS OVER* ' + players[1].name + ' : ' + players[1].health);    //Alert user with the results of the round
            round++;                //Add 1 to round.
        } else {              //Else execute
            console.log(gameOver);        //Alert user with the results of the round.

...
function whileLoop() {
    ...
    while (!gameOver) {          //While gameOver is false execute
        ...
        player1[1] -= fight(p2MaxDmg);     //Subtract the number generated by the fight function from Player 1's health based on the Player 2's max damage
        player2[1] -= fight(p1MaxDmg);     //Subtract the number generated by the fight function from Player 2's health based on the Player 1's max damage

...
console.log('------------ Regular Expressions -------------------');
    ...
    var string1 = 'This is the longest string ever.',
        string2 = 'This is the shortest string ever.',
        string3 = 'Is this the thing called Mouna Everest?',
        string4 = 'This is the Sherman on the Mount.';

    //var regex = /this/i;
    //var regex = /this/i;        //Add i at then end to make it case insensitive
    //var regex = /^this/i;       //Add ^ for the beginning only
    //var regex = /ever\.$/i;     //Add $ at the end for end only. Also . stands for any character so it needs to be \. for period.
    var regex = /Moun./;        //Look for Moun with an additional character at the end. . is wildcard character
...
*/
    ...
    var str = "My personal email is jc@google.com but my work email is js@fullsail.edu";
    ...
    var clean = str.replace(emailRegEx,'jc@gmail.com');
    console.log(clean);
...
*/
    ...
    ****************************************************************************/
	...
	var lrgRandNum = randNum(10000, 10);
	var smRandNum = randNum(100, 1);
	...
	console.log(lrgRandNum);
	console.log(smRandNum);
